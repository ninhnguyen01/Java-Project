...
public class Newsfeed {
  ...
  public void viewArticle(int articleNumber) {
    ...
    System.out.println("The article '" + trendingArticles[articleNumber] + "' has now been viewed "
        + views[articleNumber] + " times!");
  }
  ...
  public void changeRating(int articleNumber, double newRating) {
    if (newRating > 5 || newRating < 0) {
      ...
      System.out.println(
          "The article '" + trendingArticles[articleNumber] + "' is now rated " + ratings[articleNumber] + " stars!");
    }
  }

  public static void main(String[] args) {
    String[] robotArticles = { "Oil News", "Innovative Motors", "Humans: Exterminate Or Not?", "Organic Eye Implants",
        "Path Finding in an Unknown World" };
